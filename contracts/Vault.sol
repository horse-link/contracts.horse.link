...
contract Vault is Ownable, IVault, ERC20PresetMinterPauser {
    ...
    constructor(IERC20Metadata underlying) ERC20PresetMinterPauser (
    ...
    function deposit(uint256 assets, address receiver) external withMarket() returns (uint256 shares) {
    ...
    modifier withMarket() {
        require(_market != address(0), "deposit: Not allowed until market is set");
        _;
    }
}